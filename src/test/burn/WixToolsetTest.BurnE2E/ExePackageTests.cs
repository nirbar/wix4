...
namespace WixToolsetTest.BurnE2E
{
    ...
    public class ExePackageTests : BurnE2ETests
    {
        ...
        public void PackageAlreadyExists()
        {
            ...
            Assert.True(LogVerifier.MessageInLogFile(installLogPath, "Detected package: TestExe, state: Present, authored scope: PerMachine, detected scope: PerUser, cached: No, install registration state: Absent, cache registration state: Absent"));

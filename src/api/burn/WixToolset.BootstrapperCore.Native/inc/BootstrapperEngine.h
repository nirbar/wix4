...
enum BOOTSTRAPPER_ENGINE_MESSAGE
{
    ...
    BOOTSTRAPPER_ENGINE_MESSAGE_SENDEMBEDDEDCUSTOMMESSAGE,
    BOOTSTRAPPER_ENGINE_MESSAGE_REEXTRACTUXCONTAINER,
};
...
typedef struct _BAENGINE_REEXTRACTUXCONTAINER_ARGS
{
    DWORD cbSize;
} BAENGINE_REEXTRACTUXCONTAINER_ARGS;

typedef struct _BAENGINE_REEXTRACTUXCONTAINER_RESULTS
{
    DWORD cbSize;
    int nNumReextracted;
} BAENGINE_REEXTRACTUXCONTAINER_RESULTS;

typedef struct _BAENGINE_SENDEMBEDDEDCUSTOMMESSAGE_ARGS
{
    DWORD cbSize;
    DWORD dwCode;
    LPCWSTR wzMessage;
} BAENGINE_SENDEMBEDDEDCUSTOMMESSAGE_ARGS;

typedef struct _BAENGINE_SENDEMBEDDEDCUSTOMMESSAGE_RESULTS
{
    DWORD cbSize;
    int nResult;
} BAENGINE_SENDEMBEDDEDCUSTOMMESSAGE_RESULTS;

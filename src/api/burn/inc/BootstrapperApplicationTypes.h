...
enum BOOTSTRAPPER_BEGINMSITRANSACTIONCOMPLETE_ACTION
{
    BOOTSTRAPPER_BEGINMSITRANSACTIONCOMPLETE_ACTION_NONE,
    // Instructs the engine to stop processing the chain and restart.
    // The engine will launch again after the machine is restarted.
    BOOTSTRAPPER_BEGINMSITRANSACTIONCOMPLETE_ACTION_RESTART,
    // Retry starting the transaction
    BOOTSTRAPPER_BEGINMSITRANSACTIONCOMPLETE_ACTION_RETRY,
};
...
struct BA_ONBEGINMSITRANSACTIONCOMPLETE_ARGS
{
    ...
    HRESULT hrStatus;
    BOOTSTRAPPER_APPLY_RESTART restart;
    BOOTSTRAPPER_BEGINMSITRANSACTIONCOMPLETE_ACTION recommendation;
};

struct BA_ONBEGINMSITRANSACTIONCOMPLETE_RESULTS
{
    DWORD dwApiVersion;
    BOOTSTRAPPER_BEGINMSITRANSACTIONCOMPLETE_ACTION action;
};
...
struct BA_ONEMBEDDEDCUSTOMMESSAGE_ARGS
{
    DWORD dwApiVersion;
    LPCWSTR wzPackageId;
    DWORD dwCode;
...
struct BA_ONEMBEDDEDCUSTOMMESSAGE_RESULTS
{
    DWORD dwApiVersion;
    int nResult;
};
...
struct BA_ONUNITTESTSHUTDOWN_ARGS
{
    DWORD dwApiVersion;
};

struct BA_ONUNITTESTSHUTDOWN_RESULTS
{
    DWORD dwApiVersion;
};

...
enum BA_FUNCTIONS_MESSAGE
{
    ...
    BA_FUNCTIONS_MESSAGE_ONUNITTESTSHUTDOWN = BOOTSTRAPPER_APPLICATION_MESSAGE_ONUNITTESTSHUTDOWN,
    ...
    BA_FUNCTIONS_MESSAGE_ONEMBEDDEDCUSTOMMESSAGE = BOOTSTRAPPER_APPLICATION_MESSAGE_ONEMBEDDEDCUSTOMMESSAGE,

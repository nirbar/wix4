...
namespace WixToolset.Core.Burn
{
    ...
    internal class BindBundleCommand
    {
        ...
        private static void PopulatePackageVariableCache(PackageFacade facade, IDictionary<string, string> variableCache)
        {
            ...
            {
                if (!string.IsNullOrEmpty(bundlePackage.BundleCode))
                {
                    variableCache.Add(String.Concat("bundleId.", id), bundlePackage.BundleCode);
                    variableCache.Add(String.Concat("bundleCode.", id), bundlePackage.BundleCode);
                }
            }
        }

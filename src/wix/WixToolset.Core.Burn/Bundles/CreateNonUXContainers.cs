...
namespace WixToolset.Core.Burn.Bundles
{
    ...
    internal class CreateNonUXContainers
    {
        ...
        private void CreateContainer(WixBundleContainerSymbol container, IEnumerable<WixBundlePayloadSymbol> containerPayloads)
        {
            ...
            container.Hash = null;
            container.Size = 0;
            IBurnContainerExtension containerExtension = this.ContainerExtensions.FirstOrDefault(ce => (ce.ContainerExtensionIds != null) && ce.ContainerExtensionIds.Contains(container.BootstrapperExtensionRef));
            if (containerExtension == null)
            {
                this.Messaging.Write(ErrorMessages.MissingContainerExtension(container.SourceLineNumbers, container.Id.Id, container.BootstrapperExtensionRef));
                return;
            }

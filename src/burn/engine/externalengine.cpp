    ...
    )
{
    ...
    hr = BurnPipeSendMessage(pEngineState->embeddedConnection.hPipe, BURN_EMBEDDED_MESSAGE_TYPE_CUSTOM_MESSAGE, pbData, cbData, ProcessUnknownEmbeddedMessages, NULL, &dwResult);
    ExitOnFailure(hr, "Failed to send embedded message over pipe.");

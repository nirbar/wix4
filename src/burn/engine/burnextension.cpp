...
{
    HRESULT hr = S_OK;
    BOOTSTRAPPER_EXTENSION_CONTAINER_OPEN_ARGS args = { };
    BOOTSTRAPPER_EXTENSION_CONTAINER_OPEN_RESULTS results = { };
    ...
    hr = SendRequiredBextMessage(pExtension, BOOTSTRAPPER_EXTENSION_MESSAGE_CONTAINER_OPEN, &args, &results);
...
{
    HRESULT hr = S_OK;
    BOOTSTRAPPER_EXTENSION_CONTAINER_OPEN_ATTACHED_ARGS args = { };
    BOOTSTRAPPER_EXTENSION_CONTAINER_OPEN_ATTACHED_RESULTS results = { };
    ...
    hr = SendRequiredBextMessage(pExtension, BOOTSTRAPPER_EXTENSION_MESSAGE_CONTAINER_OPEN_ATTACHED, &args, &results);
    pContext->Bex.pExtensionContext = results.pContext;
...
{
    HRESULT hr = S_OK;
    BOOTSTRAPPER_EXTENSION_CONTAINER_NEXT_STREAM_ARGS args = { };
    BOOTSTRAPPER_EXTENSION_CONTAINER_NEXT_STREAM_RESULTS results = { };
    ...
    hr = SendRequiredBextMessage(pExtension, BOOTSTRAPPER_EXTENSION_MESSAGE_CONTAINER_NEXT_STREAM, &args, &results);
    if (hr != E_NOMOREITEMS)
    {
...
{
    HRESULT hr = S_OK;
    BOOTSTRAPPER_EXTENSION_CONTAINER_STREAM_TO_FILE_ARGS args = { };
    BOOTSTRAPPER_EXTENSION_CONTAINER_STREAM_TO_FILE_RESULTS results = { };
    ...
    hr = SendRequiredBextMessage(pExtension, BOOTSTRAPPER_EXTENSION_MESSAGE_CONTAINER_STREAM_TO_FILE, &args, &results);
...
{
    HRESULT hr = S_OK;
    BOOTSTRAPPER_EXTENSION_CONTAINER_STREAM_TO_BUFFER_ARGS args = { };
    BOOTSTRAPPER_EXTENSION_CONTAINER_STREAM_TO_BUFFER_RESULTS results = { };
    ...
    hr = SendRequiredBextMessage(pExtension, BOOTSTRAPPER_EXTENSION_MESSAGE_CONTAINER_STREAM_TO_BUFFER, &args, &results);
...
)
{
    ...
    hr = SendRequiredBextMessage(pExtension, BOOTSTRAPPER_EXTENSION_MESSAGE_CONTAINER_SKIP_STREAM, &args, &results);
...
{
    HRESULT hr = S_OK;
    BOOTSTRAPPER_EXTENSION_CONTAINER_CLOSE_ARGS args = { };
    BOOTSTRAPPER_EXTENSION_CONTAINER_CLOSE_RESULTS results = { };
    ...
    hr = SendRequiredBextMessage(pExtension, BOOTSTRAPPER_EXTENSION_MESSAGE_CONTAINER_CLOSE, &args, &results);

...
const LPCWSTR BURN_COMMANDLINE_SWITCH_RELATED_UNINSTALL = L"burn.related.uninstall";
const LPCWSTR BURN_COMMANDLINE_SWITCH_RELATED_DEPENDENT_UNINSTALL = L"burn.related.dependent.uninstall";

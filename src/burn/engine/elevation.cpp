...
typedef enum _BURN_ELEVATION_MESSAGE_TYPE
{
    ...
    BURN_ELEVATION_MESSAGE_TYPE_EMBEDDED_CUSTOM_MESSAGE,
    ...
    )
{
    ...
    // serialize message data
    hr = BuffWriteString(&pbData, &cbData, pMsiTransaction->sczId);
    ...
    hr = BurnPipeSendMessage(hPipe, BURN_ELEVATION_MESSAGE_TYPE_BEGIN_MSI_TRANSACTION, pbData, cbData, ProcessMsiPackageMessages, &context, &dwResult);
    ...
    )
{
    ...
    case BURN_ELEVATION_MESSAGE_TYPE_EMBEDDED_CUSTOM_MESSAGE:
    ...
    )
{
    ...
    case GENERIC_EXECUTE_MESSAGE_CUSTOM:
        ...
        dwMessage = BURN_ELEVATION_MESSAGE_TYPE_EMBEDDED_CUSTOM_MESSAGE;
        break;
    ...
    )
{
    ...
    hr = PackageFindMsiTransactionById(pPackages, sczId, &pMsiTransaction);
    ExitOnFailure(hr, "Failed to find MSI transaction: %ls", sczId);
...
LExit:
    ...
    if (pMsiTransaction)
    {
        pMsiTransaction->sczLogPath = NULL;
    }
    ...
    )
{
    ...
    ExitOnFailure(hr, "Failed to commit MSI transaction '%ls'", sczId);
    ...
    )
{
    ...
    ExitOnFailure(hr, "Failed to rollback MSI transaction '%ls'", sczId);
    pMsiTransaction->fActive = FALSE;

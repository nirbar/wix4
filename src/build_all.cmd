...
call test\build_test.cmd %_C% || exit /b
...
for /f "usebackq delims=" %%i in (`"%ProgramFiles(x86)%\Microsoft Visual Studio\Installer\vswhere.exe" -version [17^,19^) -latest -property installationPath`) do (
